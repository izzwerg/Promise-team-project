import{o as h}from"./assets/qoute-ccc7f795.js";import"./assets/vendor-8cce9181.js";function v(){let e=JSON.parse(localStorage.getItem("favorites"))||[];const f=e.map(t=>`<li class="fav-ex-item">
    ...
    `,c=window.innerWidth;let i;c<768?i=8:i=e.length;const m=document.querySelector(".no-fav-ex-inner"),u=document.querySelector(".fav-ex-list"),p=document.querySelector(".fav-pag-btn-set");if(e.length===0?m&&(m.innerHTML=o):u&&(u.innerHTML=f,h()),i<e.length&&p){const t=document.createDocumentFragment(),l=Math.ceil(e.length/i);for(let n=1;n<=l;n++){const s=document.createElement("button");s.classList.add("fav-pagination-btn"),s.textContent=n,s.addEventListener("click",()=>{const d=(n-1)*i,y=d+i,w=e.slice(d,y).map(a=>`<li class="fav-ex-item">
              <div class="fav-ex-item-header">
                  <div class="fav-workout-box">
                      <p class="fav-workout-text">workout</p>
                  </div>
